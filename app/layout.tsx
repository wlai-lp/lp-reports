            ...
            <div className="w-64 bg-white shadow-lg">
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-center h-16 border-b">
                  <span className="text-xl font-bold text-gray-800">Support Dashboard</span>
                </div>
                ...
                <nav className="flex-1 px-4 py-6 space-y-2">
                  <Link 
                    href="/dashboard" 
                    className={`flex items-center px-4 py-2.5 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors ${
                    ...
                    >
                      <Link
                        ...
                        className={`flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors ${
                          pathname === '/reports/daily' ? 'bg-gray-100' : ''
                        }`}
                      >
                      ...
                      <Link
                        href="/reports/branch"
                        className={`flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors ${
                          pathname === '/reports/branch' ? 'bg-gray-100' : ''
                        }`}
                      >
                        <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
